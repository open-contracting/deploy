...
Whereas the monitoring service configures alerts, the alerting service sends alerts. Alerts are sent to the recipients set in ``salt/prometheus-server-alertmanager/conf-alertmanager.yml``.
