...
docker_apps:
  credere_backend:
    ...
    env:
      ...
      # Email templates
      LINK_LINK: https://ocp22.open-contracting.org
      IMAGES_BASE_URL: https://ocp22.open-contracting.org/images

# Listed out-or-order for easier comparison with credere_production.sls.
ssh:
  root:
    # Codium
